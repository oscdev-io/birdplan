...
class BirdConfigConstants(BirdConfigBase):
    ...
    def _configure_constants_bgp(self):
        ...
        self._addline("define BGP_LC_FILTERED_ORIGIN_AS = (BGP_ASN, BGP_LC_FUNCTION_FILTERED, 10);")
    ...
    def _configure_functions_bgp(self):
        ...
        self._addline('    print "[bgp_filter_asns] Adding BGP_LC_FILTERED_ORIGIN_AS to ", net;', debug=True)
        self._addline("    bgp_large_community.add(BGP_LC_FILTERED_ORIGIN_AS);")
        self._addline("  }")
        self._addline("}")
        self._addline("")
