...
"""BirdPlan commandline options for BGP quarantine remove."""
...
class BirdplanCmdlineBGPQuarantineRemove(BirdplanCmdlinePluginBase):
    """Birdplan "bgp quarantine remove" command."""
    ...
    def __init__(self) -> None:
        ...
        # Plugin setup
        self.plugin_description = "birdplan bgp quarantine remove"
    ...
    def cmd_bgp_quarantine_remove(self, args: Any) -> bool:
        """
        Birdplan "bgp quarantine remove" command.
        ...
        if cmdline.is_console:
            try:
                cmdline.birdplan.state_bgp_quarantine_remove_peer(peer)
