...
"""OSPF test for redistributed static routes."""
...
class TestOSPFRedistributeStatic(BirdPlanBaseTestCase):
    """OSPF test for redistributed static routes."""
    ...
    def test_bird_tables_static4(self, sim, helpers):
        ...
        assert r1_table == correct_result, "Result for R1 BIRD t_static4 routing table does not match what it"
