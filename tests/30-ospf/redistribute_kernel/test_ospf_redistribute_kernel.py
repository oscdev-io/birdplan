...
class TestOSPFRedistributeKernel(BirdPlanBaseTestCase):
    """OSPF test for redistributed kernel routes."""
    ...
    def test_bird_tables_kernel4(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "t_kernel4", expect_count=3)
        r2_table = self._bird_route_table(sim, "r2", "t_kernel4", expect_count=3)
    ...
    def test_bird_tables_kernel6(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "t_kernel6", expect_count=3)
        r2_table = self._bird_route_table(sim, "r2", "t_kernel6", expect_count=3)
    ...
    def test_bird_tables_master4(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "master4", expect_count=4, expect_content="'OSPF.router_id': '0.0.0.2'")
    ...
    def test_bird_tables_master6(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "master6", expect_count=4, expect_content="'OSPF.router_id': '0.0.0.2'")
    ...
    def test_bird_tables_ospf4(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "t_ospf4", expect_count=3)
        r2_table = self._bird_route_table(sim, "r2", "t_ospf4", expect_count=3)
    ...
    def test_bird_tables_ospf6(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "t_ospf6", expect_count=3)
        r2_table = self._bird_route_table(sim, "r2", "t_ospf6", expect_count=3)
