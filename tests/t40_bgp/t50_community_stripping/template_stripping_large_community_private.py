...
"""BGP large community (private) stripping test case template."""
...
class Template(TemplateBase):
    ...
    def _test_announce_routes(self, sim):
        """Announce a BGP prefix with a large community (private) which should be stripped."""
        ...
        self._exabgpcli(
            ...
            [
                ...
                f"large-community [4200000000:1:1 {large_communities}]"
            ],
        )
        self._exabgpcli(
            sim,
