...
"""BGP large community (filtered function) stripping test case template."""
...
class Template(TemplateBase):
    ...
    def _test_announce_routes(self, sim):
        """Announce a BGP prefix with a large community (filtered function) which should be stripped."""
        ...
        self._exabgpcli(
            ...
            [
                ...
                f"large-community [65000:1101:65535 {large_communities}]"
            ],
        )
        self._exabgpcli(
            sim,
