...
class Template(TemplateBase):
    ...
    def _test_announce_routes(self, sim):
        ...
        self._exabgpcli(
            ...
            "e1",
            [
                "neighbor 100.64.0.1 announce route 100.64.101.0/24 next-hop 100.64.0.3 as-path [ 65001 ] "
        ...
        self._exabgpcli(
            ...
            "e1",
            [
                "neighbor fc00:100::1 announce route fc00:101::/48 next-hop fc00:100::3 as-path [ 65001 ] "
                f"large-community [{large_communities}]"
            ],
        )
