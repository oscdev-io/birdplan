...
"""BGP blackhole not allowed test case template."""
...
class TemplateBase(TemplateSetBase):
    ...
    def _test_announce_routes(self, sim):
        """Announce a BGP blackhole that is not allowed."""
        ...
        self._exabgpcli(
            ...
            "e1",
            [
                f"neighbor 100.64.0.1 announce route 100.70.0.0/{self.test_blackhole_length4} next-hop 100.64.0.2 "
        ...
        self._exabgpcli(
            ...
            "e1",
            [
                f"neighbor fc00:100::1 announce route fc00:104::/{self.test_blackhole_length6} next-hop fc00:100::2 "
                f"large-community [ {large_communities} ] community [65535:666]"
            ],
        )
