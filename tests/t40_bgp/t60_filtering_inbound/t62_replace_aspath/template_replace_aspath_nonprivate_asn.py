...
"""BGP non-private ASN when using replace_aspath test case template."""
...
"""
    ...
    def _test_announce_routes(self, sim):
        """Announce a BGP prefix with a non-private ASN when using replace_aspath in the AS-PATH."""
        ...
        self._exabgpcli(
            ...
            "e1",
            [
                "neighbor fc00:100::1 announce route fc00:101::/48 next-hop fc00:100::2 as-path [ 65001 ] "
                f"large-community [ {large_communities} ]"
            ],
        )
