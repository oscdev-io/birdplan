    ...
    def _test_announce_routes(self, sim):
        ...
        self._exabgpcli(
            ...
            [
                ...
                "as-path [ 4200000000 4200000001 4200000002 ] "
        ...
        self._exabgpcli(
            ...
            "e1",
            [
                "neighbor 100.64.0.1 announce route 100.64.111.0/24 next-hop 100.64.0.2 "
                "as-path [ 4200000000 65100 4200000002 ] "
                f"large-community [ {large_communities} ]"
            ],
        )
        self._exabgpcli(
            ...
            "e1",
            [
                "neighbor fc00:100::1 announce route fc00:111::/48 next-hop fc00:100::2 "
                "as-path [ 4200000000 65100 4200000002 ] "
                f"large-community [ {large_communities} ]"
            ],
        )
