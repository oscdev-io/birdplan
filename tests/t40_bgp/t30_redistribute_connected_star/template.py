...
class Template(BirdPlanBaseTestCase):
    ...
    r1_interfaces = ["eth0", "eth10"]
    r1_interface_eth10 = {"mac": "02:01:00:00:00:02", "ips": ["100.101.0.1/24", "fc00:101::1/64"]}

    r2_interfaces = ["eth0", "eth10"]
    r2_interface_eth10 = {"mac": "02:02:00:00:00:02", "ips": ["100.102.0.1/24", "fc00:102::1/64"]}
    ...
    def test_bird_tables_direct4_bgp(self, sim, testpath):
        """Test BIRD t_direct4_bgp table."""
        self._test_bird_routers_table("t_direct4_bgp", sim, testpath)

    def test_bird_tables_direct6_bgp(self, sim, testpath):
        """Test BIRD t_direct6_bgp table."""
        self._test_bird_routers_table("t_direct6_bgp", sim, testpath)
