...
class TemplateBase(TemplateSetBase):
    ...
    def _test_announce_routes(self, sim):
        ...
        self._exabgpcli(
            ...
            "e1",
            [
                f"neighbor 100.64.0.1 announce route 100.64.101.0/{self.test_prefix_length4} next-hop 100.64.0.2 "
        ...
        self._exabgpcli(
            ...
            "e1",
            [
                f"neighbor fc00:100::1 announce route fc00:101::/{self.test_prefix_length6} next-hop fc00:100::2 "
                f"large-community [ {large_communities} ]"
            ],
        )
