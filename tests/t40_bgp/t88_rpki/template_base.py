...
"""BGP RPKI functionality test case template (base class for specific tests)."""
...
class TemplateBase(BirdPlanBaseTestCase):
    ...
    a1_asn = 65100
    a1_interfaces = ["eth0"]
    a1_interface_eth0 = {"mac": "02:a1:00:00:00:01", "ips": ["100.64.0.101/24", "fc00:100::101/64"]}
    a1_switch_eth0 = "s1"
    ...
    def test_announce_routes(self, sim):
        ...
        self._exabgpcli(
            ...
            "e1",
            [
                "neighbor 100.64.0.1 announce route 100.64.102.0/24 next-hop 100.64.0.100 "
                f"large-community [ {self.e1_template_communities} {self.e1_extra_communities} ] "
                f"{self.e1_template_extra}"
            ],
        )
        self._exabgpcli(
            ...
            "e1",
            [
                "neighbor 100.64.0.1 announce route 100.64.103.0/24 next-hop 100.64.0.100 "
                f"large-community [ {self.e1_template_communities} {self.e1_extra_communities} ] "
                f"{self.e1_template_extra}"
            ],
        )
        ...
        self._exabgpcli(
            ...
            "e1",
            [
                "neighbor fc00:100::1 announce route fc00:102::/48 next-hop fc00:100::100 "
                f"large-community [ {self.e1_template_communities} {self.e1_extra_communities} ] "
                f"{self.e1_template_extra}"
            ],
        )
        self._exabgpcli(
            ...
            "e1",
            [
                "neighbor fc00:100::1 announce route fc00:103::/48 next-hop fc00:100::100 "
                f"large-community [ {self.e1_template_communities} {self.e1_extra_communities} ] "
                f"{self.e1_template_extra}"
            ],
        )
