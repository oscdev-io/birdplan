...
"""BGP graceful shutdown inbound (global)."""
...
class BGPGracefulShutdownInboundGlobalBase(BirdPlanBaseTestCase):
    """Base class for BGP graceful shutdown inbound (global)."""
...
class TestCustomer(BGPGracefulShutdownInboundGlobalBase):
...
class TestPeer(BGPGracefulShutdownInboundGlobalBase):
...
class TestTransit(BGPGracefulShutdownInboundGlobalBase):
...
class TestRrclient(BGPGracefulShutdownInboundGlobalBase):
...
class TestRrserver(BGPGracefulShutdownInboundGlobalBase):
...
class TestRrserverRrserver(BGPGracefulShutdownInboundGlobalBase):
...
class TestRoutecollector(BGPGracefulShutdownInboundGlobalBase):
...
class TestRouteserver(BGPGracefulShutdownInboundGlobalBase):
