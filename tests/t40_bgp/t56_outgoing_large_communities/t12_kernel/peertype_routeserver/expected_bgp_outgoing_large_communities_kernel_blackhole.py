...
r1_t_bgp4_AS65001_r2_peer = {
    ...
    "100.121.0.0/24": [
        {
            ...
            "nexthops": [{"gateway": "100.101.0.3", "interface": "eth1"}],
            "pref": 10,
            "prefix_type": "unicast",
            "protocol": "kernel4",
            "type": ["inherit", "univ"],
    ...
    "100.133.0.0/24": [
        {
            "attributes": {"BGP.community": [(65535, 666)], "BGP.large_community": [(65000, 3, 1)], "BGP.local_pref": 940},
            "pref": 200,
            "prefix_type": "blackhole",
            "protocol": "static4",
            "type": ["static", "univ"],
    ...
    "100.101.0.0/24": [
        {
            ...
            "attributes": {
                "BGP.as_path": [65000],
                "BGP.large_community": [(65000, 3, 1), (65001, 3, 5)],
                "BGP.local_pref": 450,
    ...
    "100.113.0.0/24": [
        {
            ...
            "attributes": {
                "BGP.as_path": [65000],
                "BGP.large_community": [(65000, 3, 1), (65000, 1200, 2), (65001, 3, 5)],
                "BGP.local_pref": 450,
                "BGP.next_hop": ["100.64.0.1"],
                "BGP.origin": "IGP",
            },
    ...
    "100.123.0.0/31": [
        {
            ...
            "attributes": {
                "BGP.as_path": [65000],
                "BGP.community": [(65535, 666)],
                "BGP.large_community": [(65000, 3, 1), (65000, 5000, 1), (65001, 3, 5), (65001, 1101, 26)],
                "BGP.local_pref": 450,
                "BGP.next_hop": ["100.64.0.1"],
                "BGP.origin": "IGP",
            },
    ...
    "100.133.0.0/24": [
        {
            ...
            "attributes": {
                "BGP.as_path": [65000],
                "BGP.community": [(65535, 666)],
                "BGP.large_community": [(65000, 3, 1), (65001, 3, 5), (65001, 1101, 26)],
                "BGP.local_pref": 450,
                "BGP.next_hop": ["100.64.0.1"],
                "BGP.origin": "IGP",
            },
    ...
    "100.64.104.0/24": [
        {
            ...
            "attributes": {
                "BGP.as_path": [65000],
                "BGP.large_community": [(65000, 3, 2), (65001, 3, 5)],
                "BGP.local_pref": 450,
                "BGP.next_hop": ["100.64.0.1"],
                "BGP.origin": "IGP",
            },
    ...
    "100.64.104.100/31": [
        {
            ...
            "attributes": {
                "BGP.as_path": [65000],
                "BGP.community": [(65535, 666)],
                "BGP.large_community": [(65000, 3, 2), (65000, 666, 65412), (65000, 666, 65413), (65001, 3, 5), (65001, 1101, 26)],
                "BGP.local_pref": 450,
                "BGP.next_hop": ["100.64.0.1"],
                "BGP.origin": "IGP",
            },
    ...
    "100.65.103.100/31": [
        {
            ...
            "attributes": {
                "BGP.as_path": [65000],
                "BGP.community": [(65535, 666)],
                "BGP.large_community": [(65000, 3, 1), (65000, 666, 65412), (65000, 666, 65413), (65001, 3, 5), (65001, 1101, 26)],
                "BGP.local_pref": 450,
                "BGP.next_hop": ["100.64.0.1"],
                "BGP.origin": "IGP",
            },
    ...
    "fc00:121::/48": [
        {
            ...
            "nexthops": [{"gateway": "fc00:101::3", "interface": "eth1"}],
            "pref": 10,
            "prefix_type": "unicast",
            "protocol": "kernel6",
            "type": ["inherit", "univ"],
...
r1_inet = [
    {"dev": "eth1", "dst": "default", "flags": [], "gateway": "100.101.0.3"},
    ...
    {"dev": "eth1", "dst": "100.111.0.0/24", "flags": [], "gateway": "100.101.0.4", "metric": 600, "protocol": "bird"},
    ...
    {"dev": "eth1", "dst": "100.121.0.0/24", "flags": [], "gateway": "100.101.0.3"},
...
r1_inet6 = [
    ...
    {"dev": "eth1", "dst": "fc00:121::/48", "flags": [], "gateway": "fc00:101::3", "metric": 1024, "pref": "medium"},
    ...
    {"dev": "eth1", "dst": "default", "flags": [], "gateway": "fc00:101::3", "metric": 1024, "pref": "medium"},
]
