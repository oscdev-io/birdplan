...
class Template(TemplateBase):
    ...
    def _test_quarantine(self, sim, tmpdir):
        ...
        self._birdplan_run(sim, tmpdir, "r2", ["bgp", "quarantine", "add", "r1"])

        # Check r2 was added
        quarantine_list = self._birdplan_run(sim, tmpdir, "r2", ["bgp", "quarantine", "list"])
        assert quarantine_list == ["r1"], "Router r1 is not in the quarantine list"
