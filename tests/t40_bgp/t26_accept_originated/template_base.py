...
"""BGP accept originated route test case template."""
...
class TemplateBase(BirdPlanBaseTestCase):
    ...
    def test_bird_tables_originate4(self, sim):
        ...
        self._test_bird_routers_table(sim, "t_bgp_originate4", routers=["r1"])

    def test_bird_tables_originate6(self, sim):
        """Test BIRD originate6 table."""
        self._test_bird_routers_table(sim, "t_bgp_originate6", routers=["r1"])
