...
r1_inet = [
    {"dev": "eth2", "dst": "default", "flags": [], "gateway": "100.201.0.3"},
    {
        ...
        "metric": 600,
        "nexthops": [
            {"dev": "eth2", "flags": [], "gateway": "100.201.0.2", "weight": 1},
            {"dev": "eth2", "flags": [], "gateway": "100.201.0.4", "weight": 1},
        ],
        "protocol": "bird",
    },
...
r1_inet6 = [
    ...
    {"dev": "eth2", "dst": "fe80::/64", "flags": [], "metric": 256, "pref": "medium", "protocol": "kernel"},
    {
        ...
        "metric": 600,
        "nexthops": [
            {"dev": "eth2", "flags": [], "gateway": "fc00:201::2", "weight": 1},
            {"dev": "eth2", "flags": [], "gateway": "fc00:201::4", "weight": 1},
        ],
        "pref": "medium",
        "protocol": "bird",
    },
