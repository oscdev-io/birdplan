...
"""OSPF test for redistributed static routes without default."""
...
class TestOSPFRedistributeStaticWithoutDefault:
    """OSPF test for redistributed static routes without default."""
    ...
    def test_configure(self, sim, tmpdir):
        ...
        for router in ["r1", "r2"]:
            ...
            # Load yaml config
            birdplan.load(f"tests/ospf/redistribute_static_without_default/{router}.yaml", {"@LOGFILE@": logfile})
    ...
    def test_bird_tables_master4(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("master4", expect_count=2, expect_content="'OSPF.router_id': '0.0.0.2'")
    ...
    def test_bird_tables_master6(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("master6", expect_count=2, expect_content="'OSPF.router_id': '0.0.0.2'")
    ...
    def test_bird_tables_ospf4(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_ospf4", expect_count=1)
    ...
    def test_bird_tables_ospf6(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_ospf6", expect_count=1)
