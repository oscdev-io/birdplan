...
class TestOSPFRedistributeDefaultStatic:
    """OSPF test for redistributed default static routes."""
    ...
    def test_configure(self, sim, tmpdir):
        ...
        for router in ["r1", "r2", "r3"]:
            ...
            # Load yaml config
            birdplan.load(f"tests/ospf/redistribute_static_default/{router}.yaml", {"@LOGFILE@": logfile})
    ...
    def test_bird_tables_static4(self, sim, helpers):
        ...
        sim.add_report_obj("BIRD(r3)[t_static4]", r3_table)
    ...
    def test_bird_tables_static6(self, sim, helpers):
        ...
        sim.add_report_obj("BIRD(r3)[t_static6]", r3_table)
    ...
    def test_bird_tables_master4(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("master4", expect_count=2, expect_content="'OSPF.router_id': '0.0.0.3'")
        r2_table = sim.node("r2").birdc_show_route_table("master4", expect_count=1, expect_content="'OSPF.router_id': '0.0.0.3'")
        r3_table = sim.node("r3").birdc_show_route_table("master4", expect_count=2, expect_content="'OSPF.router_id': '0.0.0.3'")

        sim.add_report_obj("BIRD(r1)[master4]", r1_table)
        sim.add_report_obj("BIRD(r2)[master4]", r2_table)
        sim.add_report_obj("BIRD(r3)[master4]", r3_table)
    ...
    def test_bird_tables_master6(self, sim, helpers):
        ...
        r3_table = sim.node("r3").birdc_show_route_table("master6", expect_count=2)

        sim.add_report_obj("BIRD(r1)[master6]", r1_table)
        sim.add_report_obj("BIRD(r2)[master6]", r2_table)
        sim.add_report_obj("BIRD(r3)[master6]", r3_table)
    ...
    def test_bird_tables_ospf4(self, sim, helpers):
        ...
        r3_table = sim.node("r3").birdc_show_route_table("t_ospf4", expect_count=2)

        sim.add_report_obj("BIRD(r1)[t_ospf4]", r1_table)
        sim.add_report_obj("BIRD(r2)[t_ospf4]", r2_table)
        sim.add_report_obj("BIRD(r3)[t_ospf4]", r3_table)
    ...
    def test_bird_tables_ospf6(self, sim, helpers):
        ...
        r3_table = sim.node("r3").birdc_show_route_table("t_ospf6", expect_count=2)

        sim.add_report_obj("BIRD(r1)[t_ospf6]", r1_table)
        sim.add_report_obj("BIRD(r2)[t_ospf6]", r2_table)
        sim.add_report_obj("BIRD(r3)[t_ospf6]", r3_table)
    ...
    def test_bird_tables_kernel4(self, sim, helpers):
        ...
        r2_table = sim.node("r2").birdc_show_route_table("t_kernel4", expect_count=1)
        r3_table = sim.node("r3").birdc_show_route_table("t_kernel4", expect_count=2)

        sim.add_report_obj("BIRD(r1)[t_kernel_4]", r1_table)
        sim.add_report_obj("BIRD(r2)[t_kernel_4]", r2_table)
        sim.add_report_obj("BIRD(r3)[t_kernel_4]", r3_table)
    ...
    def test_bird_tables_kernel6(self, sim, helpers):
        ...
        sim.add_report_obj("BIRD(r3)[t_kernel_6]", r3_table)
