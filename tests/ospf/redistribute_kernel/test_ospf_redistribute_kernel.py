...
"""OSPF test for redistributed kernel routes."""
...
class TestOSPFRedistributeKernel:
    """OSPF test for redistributed kernel routes."""
    ...
    def test_configure(self, sim, tmpdir):
        ...
        for router in ["r1", "r2"]:
            ...
            # Load yaml config
            birdplan.load(f"tests/ospf/redistribute_kernel/{router}.yaml", {"@LOGFILE@": logfile})
    ...
    def test_bird_tables_kernel4(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_kernel4", expect_count=3)
        r2_table = sim.node("r2").birdc_show_route_table("t_kernel4", expect_count=3)
    ...
    def test_bird_tables_kernel6(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_kernel6", expect_count=3)
        r2_table = sim.node("r2").birdc_show_route_table("t_kernel6", expect_count=3)
    ...
    def test_bird_tables_master4(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("master4", expect_count=3)
        r2_table = sim.node("r2").birdc_show_route_table("master4", expect_count=3)
    ...
    def test_bird_tables_master6(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("master6", expect_count=3)
        r2_table = sim.node("r2").birdc_show_route_table("master6", expect_count=3)
    ...
    def test_bird_tables_ospf4(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_ospf4", expect_count=3)
        r2_table = sim.node("r2").birdc_show_route_table("t_ospf4", expect_count=3)
    ...
    def test_bird_tables_ospf6(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_ospf6", expect_count=3)
        r2_table = sim.node("r2").birdc_show_route_table("t_ospf6", expect_count=3)
