...
class TestRIPRedistributeStaticDefault(BirdPlanBaseTestCase):
    """RIP test for redistributed default static routes."""
    ...
    def test_bird_tables_rip4(self, sim, helpers):
        ...
        r3_table = self._bird_route_table(sim, "r3", "t_rip4", expect_count=1)
    ...
    def test_bird_tables_rip6(self, sim, helpers):
        ...
        r3_table = self._bird_route_table(sim, "r3", "t_rip6", expect_count=1)
