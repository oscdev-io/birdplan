...
"""RIP test for redistributed static routes without default."""
...
class TestRIPRedistributeStaticWithoutDefault(BirdPlanBaseTestCase):
    """RIP test for redistributed static routes without default."""
    ...
    def test_bird_tables_rip4(self, sim):
        ...
        r1_table = self._bird_route_table(sim, "r1", "t_rip4")
        r2_table = self._bird_route_table(sim, "r2", "t_rip4")
    ...
    def test_bird_tables_rip6(self, sim):
        ...
        r1_table = self._bird_route_table(sim, "r1", "t_rip6")
        r2_table = self._bird_route_table(sim, "r2", "t_rip6")
