...
class TestRIPRedistributeKernel(BirdPlanBaseTestCase):
    """RIP test for redistributed kernel routes."""
    ...
    def test_bird_tables_master4(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "master4", expect_count=4)
    ...
    def test_bird_tables_master6(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "master6", expect_count=4)
    ...
    def test_bird_tables_rip4(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "t_rip4", expect_count=2)
        r2_table = self._bird_route_table(sim, "r2", "t_rip4", expect_count=2)
    ...
    def test_bird_tables_rip6(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "t_rip6", expect_count=2)
        r2_table = self._bird_route_table(sim, "r2", "t_rip6", expect_count=2)
