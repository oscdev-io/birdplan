    ...
    "100.102.0.0/24": [
        {
            ...
            "nexthops": [
                ...
                {"gateway": "100.64.0.5", "interface": "eth0", "weight": 1},
                {"gateway": "100.64.0.6", "interface": "eth0", "weight": 1},
                {"gateway": "100.64.0.7", "interface": "eth0", "weight": 1},
            ],
            "ospf_type": "I",
            "pref": 150,
            "prefix_type": "unicast",
    ...
    "100.131.0.0/24": [
        {
            ...
            "nexthops": [
                ...
                {"gateway": "100.102.0.3", "interface": "eth0", "weight": 1},
                {"gateway": "100.102.0.4", "interface": "eth0", "weight": 1},
                {"gateway": "100.102.0.5", "interface": "eth0", "weight": 1},
                {"gateway": "100.102.0.6", "interface": "eth0", "weight": 1},
                {"gateway": "100.102.0.7", "interface": "eth0", "weight": 1},
            ],
            "ospf_type": "E2",
            "pref": 150,
            "prefix_type": "unicast",
    ...
    "fc00:100::/64": [
        {
            ...
            "nexthops": [
                ...
                {"gateway": "fe80::3:ff:fe00:2", "interface": "eth0", "weight": 1},
                {"gateway": "fe80::4:ff:fe00:2", "interface": "eth0", "weight": 1},
                {"gateway": "fe80::5:ff:fe00:2", "interface": "eth0", "weight": 1},
                {"gateway": "fe80::6:ff:fe00:2", "interface": "eth0", "weight": 1},
                {"gateway": "fe80::7:ff:fe00:2", "interface": "eth0", "weight": 1},
            ],
            "ospf_type": "I",
            "pref": 150,
            "prefix_type": "unicast",
...
r1_inet = [
    ...
    {"dev": "eth0", "dst": "100.64.0.0/24", "flags": [], "metric": 600, "protocol": "bird", "scope": "link"},
    {
        ...
        "nexthops": [
            ...
            {"dev": "eth0", "flags": [], "gateway": "100.64.0.5", "weight": 1},
            {"dev": "eth0", "flags": [], "gateway": "100.64.0.6", "weight": 1},
            {"dev": "eth0", "flags": [], "gateway": "100.64.0.7", "weight": 1},
        ],
        "protocol": "bird",
    },
...
r8_inet = [
    {
        ...
        "nexthops": [
            ...
            {"dev": "eth0", "flags": [], "gateway": "100.102.0.5", "weight": 1},
            {"dev": "eth0", "flags": [], "gateway": "100.102.0.6", "weight": 1},
            {"dev": "eth0", "flags": [], "gateway": "100.102.0.7", "weight": 1},
        ],
        "protocol": "bird",
    },
...
r8_inet6 = [
    {
        ...
        "nexthops": [
            ...
            {"dev": "eth0", "flags": [], "gateway": "fe80::5:ff:fe00:2", "weight": 1},
            {"dev": "eth0", "flags": [], "gateway": "fe80::6:ff:fe00:2", "weight": 1},
            {"dev": "eth0", "flags": [], "gateway": "fe80::7:ff:fe00:2", "weight": 1},
        ],
        "pref": "medium",
        "protocol": "bird",
    },
