...
class TestBGPBasic:
    ...
    def test_bird_tables_bgp_originate4(self, sim, helpers):
        """Test BIRD bgp_originate4 table."""

        r1_table = sim.node("r1").birdc_show_route_table("t_bgp_originate4", expect_count=1)
        r2_table = sim.node("r2").birdc_show_route_table("t_bgp_originate4", expect_count=1)
    ...
    def test_bird_tables_bgp_originate6(self, sim, helpers):
        """Test BIRD bgp_originate6 table."""

        r1_table = sim.node("r1").birdc_show_route_table("t_bgp_originate6", expect_count=1)
        r2_table = sim.node("r2").birdc_show_route_table("t_bgp_originate6", expect_count=1)
