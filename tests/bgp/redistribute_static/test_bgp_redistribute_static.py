...
class TestBGPRedistributeStatic:
    """BGP test for redistribution of static routes."""
    ...
    def test_configure(self, sim, tmpdir):
        ...
        for router in ["r1", "r2"]:
            ...
            # Load yaml config
            birdplan.load(f"tests/bgp/redistribute_static/{router}.yaml", {"@LOGFILE@": logfile})
    ...
    def test_bird_tables_bgp_originate4(self, sim):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_bgp_originate4")
        r2_table = sim.node("r2").birdc_show_route_table("t_bgp_originate4")

        sim.add_report_obj("BIRD(r1)[t_bgp_originate4]", r1_table)
        sim.add_report_obj("BIRD(r2)[t_bgp_originate4]", r2_table)
    ...
    def test_bird_tables_bgp_originate6(self, sim):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_bgp_originate6")
        r2_table = sim.node("r2").birdc_show_route_table("t_bgp_originate6")

        sim.add_report_obj("BIRD(r1)[t_bgp_originate6]", r1_table)
        sim.add_report_obj("BIRD(r2)[t_bgp_originate6]", r2_table)
    ...
    def test_bird_tables_static4(self, sim, helpers):
        ...
        r2_table = sim.node("r2").birdc_show_route_table("t_static4", expect_count=1)
    ...
    def test_bird_tables_static6(self, sim, helpers):
        ...
        r2_table = sim.node("r2").birdc_show_route_table("t_static6", expect_count=1)
    ...
    def test_bird_tables_bgp_peer4(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_bgp_AS65001_r2_peer4", expect_count=1)
        r2_table = sim.node("r2").birdc_show_route_table("t_bgp_AS65000_r1_peer4", expect_count=1)

        sim.add_report_obj("BIRD(r1)[t_bgp_AS65001_r2_peer4]", r1_table)
        sim.add_report_obj("BIRD(r2)[t_bgp_AS65000_r1_peer4]", r2_table)
    ...
    def test_bird_tables_bgp_peer6(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_bgp_AS65001_r2_peer6", expect_count=1)
        r2_table = sim.node("r2").birdc_show_route_table("t_bgp_AS65000_r1_peer6", expect_count=1)

        sim.add_report_obj("BIRD(r1)[t_bgp_AS65001_r2_peer6]", r1_table)
        sim.add_report_obj("BIRD(r2)[t_bgp_AS65000_r1_peer6]", r2_table)
    ...
    def test_bird_tables_bgp4(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_bgp4", expect_count=1)
        r2_table = sim.node("r2").birdc_show_route_table("t_bgp4", expect_count=2)

        sim.add_report_obj("BIRD(r1)[t_bgp4]", r1_table)
        sim.add_report_obj("BIRD(r2)[t_bgp4]", r2_table)
    ...
    def test_bird_tables_bgp6(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_bgp6", expect_count=1)
        r2_table = sim.node("r2").birdc_show_route_table("t_bgp6", expect_count=2)

        sim.add_report_obj("BIRD(r1)[t_bgp6]", r1_table)
        sim.add_report_obj("BIRD(r2)[t_bgp6]", r2_table)
