...
"""BGP test for NOEXPORT to the peer peer type."""
...
class TestBGPLCNoExportPeer(BirdPlanBaseTestCase):
    """BGP test for NOEXPORT to the peer peer type."""
    ...
    def test_create_topology(self, sim, tmpdir):
        ...
        self._exabgpcli(
            sim,
            "e1",
            ["neighbor 100.64.0.1 announce route 100.64.101.0/24 next-hop 100.64.0.10 large-community [ 65000:4:65413 ]"],
        )
        self._exabgpcli(
            sim,
            "e1",
            ["neighbor fc00:100::1 announce route fc00:101::/48 next-hop fc00:100::10 large-community [ 65000:4:65413 ]"],
        )
            ...
            "100.64.101.0/24": [
                {
                    ...
                    "attributes": {
                        "BGP.as_path": [65010],
                        "BGP.large_community": [(65000, 4, 65413), (65000, 3, 2)],
                        "BGP.local_pref": 750,
    ...
    def test_bird_table_bgp_peer_r1_r2(self, sim, helpers):
    ...
    def test_bird_table_bgp_peer_r1_r3(self, sim):
    ...
    def test_bird_table_bgp_peer_r1_r8(self, sim):
    ...
    def test_bird_table_bgp_peer_r1_r9(self, sim):
    ...
    def test_bird_table_bgp_peer_r2_r1(self, sim, helpers):
            ...
            "100.64.101.0/24": [
                {
                    ...
                    "attributes": {
                        ...
                        "BGP.large_community": [(65000, 3, 2), (65000, 4, 65413), (65002, 3, 4)],
                        "BGP.local_pref": 150,
    ...
    def test_bird_table_bgp_peer_r3_r1(self, sim):
        """Test r3's r1 BGP peer table."""

        peer_bgp_table_name = self._bird_bgp_peer_table(sim, "r3", "r1", 4)
        peer_bgp4_table = self._bird_route_table(sim, "r3", peer_bgp_table_name)

        peer_bgp_table_name = self._bird_bgp_peer_table(sim, "r3", "r1", 6)
        peer_bgp6_table = self._bird_route_table(sim, "r3", peer_bgp_table_name)
            ...
            "100.64.101.0/24": [
                {
                    ...
                    "attributes": {
                        "BGP.as_path": [65000, 65010],
                        "BGP.large_community": [(65000, 3, 2), (65000, 4, 65413), (65004, 3, 2)],
                        "BGP.local_pref": 750,
                        "BGP.next_hop": ["100.64.0.1"],
                        "BGP.origin": "IGP",
                    },
            ...
            "100.64.101.0/24": [
                {
                    ...
                    "attributes": {
                        "BGP.as_path": [65010],
                        "BGP.large_community": [(65000, 3, 2), (65000, 4, 65413)],
                        "BGP.local_pref": 750,
                        "BGP.next_hop": ["100.64.0.10"],
                        "BGP.origin": "IGP",
                    },
    ...
    def test_bird_table_bgp_peer_r8_r1(self, sim):
        """Test r8's r1 BGP peer table."""

        peer_bgp_table_name = self._bird_bgp_peer_table(sim, "r8", "r1", 4)
        peer_bgp4_table = self._bird_route_table(sim, "r8", peer_bgp_table_name)

        peer_bgp_table_name = self._bird_bgp_peer_table(sim, "r8", "r1", 6)
        peer_bgp6_table = self._bird_route_table(sim, "r8", peer_bgp_table_name)
    ...
    def test_bird_table_bgp_peer_r9_r1(self, sim):
        """Test r9's r1 BGP peer table."""

        peer_bgp_table_name = self._bird_bgp_peer_table(sim, "r9", "r1", 4)
        peer_bgp4_table = self._bird_route_table(sim, "r9", peer_bgp_table_name)

        peer_bgp_table_name = self._bird_bgp_peer_table(sim, "r9", "r1", 6)
        peer_bgp6_table = self._bird_route_table(sim, "r9", peer_bgp_table_name)
    ...
    def test_bird_table_bgp_r8(self, sim):
        """Test BIRD main bgp routing tables."""
    ...
    def test_bird_table_bgp_r9(self, sim):
        """Test BIRD main bgp routing tables."""
