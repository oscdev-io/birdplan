...
class TestBGPLCNoExportPeerASN(BirdPlanBaseTestCase):
    ...
    def test_create_topology(self, sim, tmpdir):
        ...
        self._exabgpcli(
            sim,
            "e1",
            ["neighbor 100.64.0.1 announce route 100.64.101.0/24 next-hop 100.64.0.10 large-community [ 65000:4:65003 ]"],
        )
        self._exabgpcli(
            sim,
            "e1",
            ["neighbor fc00:100::1 announce route fc00:101::/48 next-hop fc00:100::10 large-community [ 65000:4:65003 ]"],
        )
