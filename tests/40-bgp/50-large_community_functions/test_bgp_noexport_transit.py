...
"""BGP test for NOEXPORT to the transit peer type."""
...
class TestBGPLCNoExportTransit(BirdPlanBaseTestCase):
    """BGP test for NOEXPORT to the transit peer type."""
    ...
    def test_create_topology(self, sim, tmpdir):
        ...
        self._exabgpcli(
            sim,
            "e1",
            ["neighbor 100.64.0.1 announce route 100.64.101.0/24 next-hop 100.64.0.10 large-community [ 65000:4:65412 ]"],
        )
        self._exabgpcli(
            sim,
            "e1",
            ["neighbor fc00:100::1 announce route fc00:101::/48 next-hop fc00:100::10 large-community [ 65000:4:65412 ]"],
        )
            ...
            "100.64.101.0/24": [
                {
                    ...
                    "attributes": {
                        "BGP.as_path": [65010],
                        "BGP.large_community": [(65000, 4, 65412), (65000, 3, 2)],
                        "BGP.local_pref": 750,
    ...
    def test_bird_table_bgp_peer_r1_r4(self, sim):
            ...
            "100.64.101.0/24": [
                {
                    ...
                    "attributes": {
                        ...
                        "BGP.large_community": [(65000, 3, 2), (65000, 4, 65412), (65002, 3, 4)],
                        "BGP.local_pref": 150,
            ...
            "100.64.101.0/24": [
                {
                    ...
                    "attributes": {
                        "BGP.as_path": [65000, 65010],
                        "BGP.large_community": [(65000, 3, 2), (65000, 4, 65412), (65003, 3, 3)],
                        "BGP.local_pref": 470,
                        "BGP.next_hop": ["100.64.0.1"],
                        "BGP.origin": "IGP",
                    },
    ...
    def test_bird_table_bgp_peer_r4_r1(self, sim):
            ...
            "100.64.101.0/24": [
                {
                    ...
                    "attributes": {
                        "BGP.as_path": [65010],
                        "BGP.large_community": [(65000, 3, 2), (65000, 4, 65412)],
                        "BGP.local_pref": 750,
                        "BGP.next_hop": ["100.64.0.10"],
                        "BGP.origin": "IGP",
                    },
            ...
            "100.64.101.0/24": [
                {
                    ...
                    "attributes": {
                        "BGP.as_path": [65000, 65010],
                        "BGP.large_community": [(65000, 3, 2), (65000, 4, 65412), (65008, 3, 3)],
                        "BGP.local_pref": 470,
                        "BGP.next_hop": ["100.64.0.1"],
                        "BGP.origin": "IGP",
                    },
            ...
            "100.64.101.0/24": [
                {
                    ...
                    "attributes": {
                        "BGP.as_path": [65000, 65010],
                        "BGP.large_community": [(65000, 3, 2), (65000, 4, 65412), (65009, 3, 3)],
                        "BGP.local_pref": 470,
                        "BGP.next_hop": ["100.64.0.1"],
                        "BGP.origin": "IGP",
                    },
    ...
    def test_bird_table_bgp_r4(self, sim):
        """Test BIRD main bgp routing tables."""
