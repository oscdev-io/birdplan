...
"""BGP test for redistributed connected routes using a star."""
...
class TestBGPRedistributeConnectedWithStar(BirdPlanBaseTestCase):
    """BGP test for redistributed connected routes using a star."""
    ...
    def test_create_topology(self, sim, tmpdir):
        ...
        sim.node("r1").add_interface("eth10", mac="02:01:00:00:00:02", ips=["100.101.0.0/24", "fc00:101::1/48"])
    ...
    def test_os_rib_inet(self, sim):
        ...
        correct_result = [
            ...
            {"dev": "eth10", "dst": "100.101.0.0/24", "flags": [], "prefsrc": "100.101.0.0", "protocol": "kernel", "scope": "link"},
        ]
    ...
    def test_os_rib_inet6(self, sim):
        ...
        correct_result = [
            ...
            {"dev": "eth10", "dst": "fc00:101::/48", "flags": [], "metric": 256, "pref": "medium", "protocol": "kernel"},
