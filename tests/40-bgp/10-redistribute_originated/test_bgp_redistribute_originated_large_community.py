...
"""BGP test for redistribution of originated routes with large communities."""

import os
from basetests import BirdPlanBaseTestCase


class TestBGPRedistributeOriginatedLargeCommunity(BirdPlanBaseTestCase):
    """BGP test for redistribution of originated routes with large communities."""
...
"""
    ...
    def test_bird_tables_bgp_originate4(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "t_bgp_originate4", expect_count=1)
        r2_table = self._bird_route_table(sim, "r2", "t_bgp_originate4", expect_count=1)
    ...
    def test_bird_tables_bgp_originate6(self, sim, helpers):
        ...
        r1_table = self._bird_route_table(sim, "r1", "t_bgp_originate6", expect_count=1)
        r2_table = self._bird_route_table(sim, "r2", "t_bgp_originate6", expect_count=1)
