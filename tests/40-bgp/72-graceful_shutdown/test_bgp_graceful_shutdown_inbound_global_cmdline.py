...
"""BGP graceful shutdown inbound from commandline (globally)."""
...
class BGPGracefulShutdownInboundGlobalCmdlineBase(BirdPlanBaseTestCase):
    """Base class for BGP graceful shutdown inbound from commandline (globally)."""
...
"""
    ...
    def test_remove_graceful_shutdown(self, sim, tmpdir):
        ...
        self._birdplan_run(sim, tmpdir, "r1", ["bgp", "graceful_shutdown", "remove", "*"])
...
class TestCustomer(BGPGracefulShutdownInboundGlobalCmdlineBase):
...
class TestPeer(BGPGracefulShutdownInboundGlobalCmdlineBase):
...
class TestTransit(BGPGracefulShutdownInboundGlobalCmdlineBase):
...
class TestRrclient(BGPGracefulShutdownInboundGlobalCmdlineBase):
...
class TestRrserver(BGPGracefulShutdownInboundGlobalCmdlineBase):
...
class TestRrserverRrserver(BGPGracefulShutdownInboundGlobalCmdlineBase):
...
class TestRoutecollector(BGPGracefulShutdownInboundGlobalCmdlineBase):
...
class TestRouteserver(BGPGracefulShutdownInboundGlobalCmdlineBase):
