...
class BGPStrippingLargeCommunitiesBase(BirdplanBaseTestCaseExabgp):
    ...
    def _announce_strippable_large_community(self, sim) -> Tuple:
        """Announce a prefix that has a strippable large community from ExaBGP to BIRD."""

        self._exabgpcli(
            sim,
            "e1",
            ["neighbor 100.64.0.1 announce route 100.64.101.0/24 next-hop 100.64.0.2 large-community [" + "65000:1100:65535" + "]"],
        )
        self._exabgpcli(
            sim,
            "e1",
            ["neighbor fc00:100::1 announce route fc00:101::/48 next-hop fc00:100::2 large-community [" + "65000:1100:65535" + "]"],
        )
        ...
        assert len(peer_bgp4_table) == 1, "Failed to announce IPv4 with a strippable large community"
        ...
        assert len(peer_bgp6_table) == 1, "Failed to announce IPv6 with a strippable large community"
...
"""
    ...
    def test_strippable_large_community_announce(self, sim, tmpdir, helpers):
        """Test stripping of large communities for the 'customer' peer type."""
        ...
        # Announce prefixes
        ipv4_table, ipv6_table = self._announce_strippable_large_community(sim)
            ...
            "100.64.101.0/24": [
                {
                    "attributes": {
                        "BGP.as_path": [],
                        "BGP.large_community": [(65000, 1100, 65535)],
                        "BGP.local_pref": 100,
                        "BGP.next_hop": ["100.64.0.2"],
                        "BGP.origin": "IGP",
                    },
