...
class TestRipRedistributeConnectedWithStar:
    ...
    def test_configure(self, sim, tmpdir):
        ...
        for router in ["r1", "r2"]:
            ...
            # Load yaml config
            birdplan.load(f"tests/rip/redistribute_connected_with_star/{router}.yaml", {"@LOGFILE@": logfile})
    ...
    def test_create_topology(self, sim, tmpdir):
        ...
        sim.node("r1").add_interface("eth10", mac="02:01:00:00:00:02", ips=["192.168.10.1/24", "fc10::1/64"])
    ...
    def test_bird_tables_direct4(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_direct4_rip")
    ...
    def test_bird_tables_direct6(self, sim, helpers):
        ...
        r1_table = sim.node("r1").birdc_show_route_table("t_direct6_rip")
    ...
    def test_os_rib_inet6(self, sim):
        ...
        correct_result = [
            ...
            {"dev": "eth10", "dst": "fc10::/64", "flags": [], "metric": 256, "pref": "medium", "protocol": "kernel"},
