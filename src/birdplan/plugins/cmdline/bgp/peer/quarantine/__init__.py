...
class BirdPlanCmdlineBGPPeerQuarantine(BirdPlanCmdlinePluginBase):
    ...
    def cmd_bgp_peer_quarantine(self, args: dict[str, Any]) -> None:  # noqa: ARG002
        """
        ...
        raise BirdPlanUsageError("No options specified to 'bgp peer quarantine' action", self._subparser)
